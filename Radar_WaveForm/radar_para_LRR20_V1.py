# -*- coding: utf-8 -*-
"""
Created on Fri Mar 23 13:47:38 2018
...
class Waveform(object):
    def __init__(self,fs,L,N,NF,Tdwell,Tchirp_up,Treset,f,Bw):
...
lrr20 = Waveform(40*1e6, 256,512,192, 8*1e-6, 19*1e-6, 3*1e-6, 77*1e9, 670*1e6)
#print(lrr20.vsep())
#lrr20.print_para()
